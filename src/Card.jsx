...
const Card = ({ obj }) => {
  ...
  const getdata = async () => {
      ...
      const response = await axios.post(`https://internshalademo2.onrender.com/apply`, {}, {
        headers: {
      ...
      if (response.data.res == true ) {
       ...
       if (ans == true ){
        ...
        let data = await axios.post(`https://internshalademo2.onrender.com/addinternship` , {user : response.data.user , _id : _id})
        console.log(data)
